...
export default function NavBar(props) {
    ...
    function handleOrgClicked() {
        alert('apis are not ready!');
        // navigate('/organizations', {state:apiFetchedData});
    }
